...
window.addEventListener('load', async function() {
  const storedMeetingCode = localStorage.getItem('meetingCode');
  const userName = localStorage.getItem('userName');
  
  if (storedMeetingCode && userName) {
      document.getElementById('joinMeetingId').value = storedMeetingCode;
      document.getElementById('name').value = userName;
      // Auto join the meeting
      joinMeeting(false);
      // Clear the stored codes after joining
